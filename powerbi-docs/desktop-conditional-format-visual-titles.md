...
이들은 Power BI Desktop에서 시각화에 대해 동적, 식 기반 제목을 만드는 데 사용할 수있는 몇 가지 예입니다. 제목을 사용하여 수행할 수 있는 작업은 여러분의 상상 및 모델에 의해서만 제한 됩니다.
...
필드를 선택하고 적용하려면 **시각화** 창으로 이동입니다. **서식** 영역에서 **제목**을 선택하여 시각적 개체에 대한 제목 옵션을 표시 합니다. 
...
시각적 개체에 대한 식 기반 제목츼 현재 구현에 몇 가지 제한이 있습니다.

* 식 기반 형식은 Python 시각적 개체, R 시각적 개체 또는 주요 영향 요인 시각적 개체에서 현재 지원되지 않습니다.
